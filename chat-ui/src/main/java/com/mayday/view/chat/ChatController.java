...
import com.mayday.util.CacheUtil;
import com.mayday.util.Ids;
import com.mayday.view.chat.data.GroupsData;
import com.mayday.view.chat.data.RemindCount;
import com.mayday.view.chat.data.TalkData;
import com.mayday.view.chat.group_bar_chat.ElementInfoBox;
import com.mayday.view.chat.group_bar_chat.ElementTalk;
import com.mayday.view.chat.group_bar_friend.ElementFriendGroup;
import com.mayday.view.chat.group_bar_friend.ElementFriendLuckUser;
import com.mayday.view.chat.group_bar_friend.ElementFriendUser;
...
public class ChatController extends ChatInit implements IChatMethod {
    ...
    public void setUserInfo(String userId, String userNickName, String userHead) {
        ...
        Pane head = $("bar_portrait", Pane.class);
